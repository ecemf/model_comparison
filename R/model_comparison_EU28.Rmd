...
#select Years
#dfLong <- dfLong[dfLong$period <= 2050,] 
...
g$emiCO2 <- ggplot(d,aes(x=period,y=value,color=Model,group=Model)) + 
  ...
  scale_color_manual(values = color$model) +
  ylab("Emissions|CO2 (Mt CO2/yr)") +
...
maxY <- max(as.data.frame(d2 %>% group_by(period,Model,Scenario) %>% summarize(value = sum(value)))[,]$value)

g$emiSource <- arrangeGrob(
    ggplot(d[d$Scenario %in% c("DIAG-Base", "DIAG-NPI", "DIAG-C80-gr5"),],aes(x=Model,y=value,fill=Variable)) +
    geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
    geom_point(data=d2[d2$Scenario %in% c("DIAG-Base", "DIAG-NPI", "DIAG-C80-gr5"),],aes(x=Model,y=value,fill="gray"), shape=23, alpha = 0.5) +
    geom_bar(stat='identity') +
    facet_grid(~Scenario+period, labeller = labeller(Scenario = function(Variable, value) {c("", "DIAG-Base","","","DIAG-NPI","","","DIAG-C80-gr5","")})) +
    theme_singleColumn() + 
    scale_fill_manual(values = setNames(color$emi[names(vars)],vars), labels = setNames(names(vars),vars)) +
    guides(fill="none") +
    ...
    ,
    ggplot(d[d$Scenario %in% c("DIAG-C0to80-gr5", "DIAG-C400-lin", "DIAG-NZero"),],aes(x=Model,y=value,fill=Variable)) +
    geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
    geom_point(data=d2[d2$Scenario %in% c("DIAG-C0to80-gr5", "DIAG-C400-lin", "DIAG-NZero"),],aes(x=Model,y=value,fill="gray"), shape=23, alpha = 0.5) +
    geom_bar(stat='identity') +
    facet_grid(~Scenario+period, labeller = labeller(Scenario = function(Variable, value) {c("", "DIAG-C0to80-gr5","","","DIAG-C400-lin","","","DIAG-NZero","")})) +
    theme_singleColumn() + 
    scale_fill_manual(values = setNames(color$emi[names(vars)],vars), labels = setNames(names(vars),vars)) +
    theme(axis.title.y = element_blank()) +
    expand_limits(y=c(0,maxY)) +
...
g$carbonPrice <- ggplot(d,aes(x=period,y=value,color=Model,group=Model)) + 
  geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
  geom_vline(xintercept=2020, color = "black", size=1, alpha = 0.15, linetype = "dashed") +
  geom_line(size=1) + #,linetype=parent
  geom_point() +
  ...
  scale_color_manual(values = color$model) +
  ylab("Price|Carbon (EUR/t CO2)") +
  scale_x_continuous(breaks=c(seq(2010, 2050, 10),2070,2100))

g$carbonPrice2 <- ggplot(d,aes(x=period,y=value,color=Scenario,group=Scenario)) + 
  geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
  geom_vline(xintercept=2020, color = "black", size=1, alpha = 0.15, linetype = "dashed") +
  geom_line(size=1) + #,linetype=parent
  geom_point() +
...
g$ccs <- ggplot(d,aes(x=period,y=value,color=Model,group=Model)) + 
  geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
  geom_vline(xintercept=2020, color = "black", size=1, alpha = 0.15, linetype = "dashed") +
  geom_line(size=1) + #,linetype=parent
  geom_point() +
  ...
  scale_color_manual(values = color$model) +
  ylab("Carbon Capture and Storage (Mt CO2/yr)") +
  scale_x_continuous(breaks=seq(2010, 2050, 10))
...
g$capture <- arrangeGrob(
    ...
    facet_grid(~Scenario+period, labeller = labeller(Scenario = function(Variable, value) {c("", "DIAG-Base","","","DIAG-NPI","","","DIAG-C80-gr5","")})) +
    theme_singleColumn() + 
    scale_fill_manual(values = setNames(color$capture[names(vars)],vars), labels = setNames(names(vars),vars)) +
    guides(fill="none") +
    theme(axis.title.y = element_blank()) + 
    expand_limits(y=c(0,maxY)) +
    scale_x_discrete(drop=FALSE) +
...
g$pe <- ggplot(d,aes(x=period,y=value,color=Model,group=Model)) + 
  geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
  geom_vline(xintercept=2020, color = "black", size=1, alpha = 0.15, linetype = "dashed") +
  geom_line(size=1) + #,linetype=parent
  geom_point() +
...
g$peCarrier <- arrangeGrob(
    ...
    facet_grid(~Scenario+period, labeller = labeller(Scenario = function(Variable, value) {c("", "DIAG-Base","","","DIAG-NPI","","","DIAG-C80-gr5","")})) +
    theme_singleColumn() + 
    scale_fill_manual(values = setNames(color$tech[names(vars)],vars), labels = setNames(names(vars),vars)) +
    guides(fill="none") +
    theme(axis.title.y = element_blank()) + 
    expand_limits(y=c(0,maxY)) +
    scale_x_discrete(drop=FALSE) +
...
g$fe <- ggplot(d,aes(x=period,y=value,color=Model,group=Model)) + 
  geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
  geom_vline(xintercept=2020, color = "black", size=1, alpha = 0.15, linetype = "dashed") +
  geom_line(size=1) + #,linetype=parent
  geom_point() +
...
g$feElec <- ggplot(d,aes(x=period,y=value,color=Model,group=Model)) + 
  geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
  geom_vline(xintercept=2020, color = "black", size=1, alpha = 0.15, linetype = "dashed") +
  geom_line(size=1) + #,linetype=parent
  geom_point() +
  ...
  scale_color_manual(values = color$model) +
  ylab("Electricity Final Energy (EJ/yr)") +
  scale_x_continuous(breaks=seq(2010, 2050, 10))
...
g$feCarrier <- arrangeGrob(
    ggplot(d[d$Scenario %in% c("DIAG-Base", "DIAG-NPI", "DIAG-C80-gr5"),],aes(x=Model,y=value,fill=Variable)) +
    geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
    geom_point(data=d2[d2$Scenario %in% c("DIAG-Base", "DIAG-NPI", "DIAG-C80-gr5"),],aes(x=Model,y=value,fill="gray"), shape=23, alpha = 0.35) +
    geom_bar(stat='identity') +
    facet_grid(~Scenario+period, labeller = labeller(Scenario = function(Variable, value) {c("", "DIAG-Base","","","DIAG-NPI","","","DIAG-C80-gr5","")})) +
    theme_singleColumn() + 
    scale_fill_manual(values = setNames(color$carrier[names(vars)],vars), labels = setNames(names(vars),vars)) +
    guides(fill="none") +
    theme(axis.title.y = element_blank()) + 
    expand_limits(y=c(0,maxY)) +
    scale_x_discrete(drop=FALSE) +
    ...
    ggplot(d[d$Scenario %in% c("DIAG-C0to80-gr5", "DIAG-C400-lin", "DIAG-NZero"),],aes(x=Model,y=value,fill=Variable)) +
    geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
    geom_point(data=d2[d2$Scenario %in% c("DIAG-C0to80-gr5", "DIAG-C400-lin", "DIAG-NZero"),],aes(x=Model,y=value,fill="gray"), shape=23, alpha = 0.35) +
    geom_bar(stat='identity') +
    facet_grid(~Scenario+period, labeller = labeller(Scenario = function(Variable, value) {c("", "DIAG-C0to80-gr5","","","DIAG-C400-lin","","","DIAG-NZero","")})) +
    theme_singleColumn() + 
    scale_fill_manual(values = setNames(color$carrier[names(vars)],vars), labels = setNames(names(vars),vars)) +
...
g$feSector <- arrangeGrob(
    ...
    facet_grid(~Scenario+period, labeller = labeller(Scenario = function(Variable, value) {c("", "DIAG-Base","","","DIAG-NPI","","","DIAG-C80-gr5","")})) +
    theme_singleColumn() + 
    scale_fill_manual(values = setNames(color$sector[names(vars)],vars), labels = setNames(names(vars),vars)) +
    guides(fill="none") +
    theme(axis.title.y = element_blank()) + 
    expand_limits(y=c(0,maxY)) +
    scale_x_discrete(drop=FALSE) +
    ...
    ggplot(d[d$Scenario %in% c("DIAG-C0to80-gr5", "DIAG-C400-lin", "DIAG-NZero"),],aes(x=Model,y=value,fill=Variable)) +
    geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
    geom_point(data=d2[d2$Scenario %in% c("DIAG-C0to80-gr5", "DIAG-C400-lin", "DIAG-NZero"),],aes(x=Model,y=value,fill="gray"), shape=23, alpha = 0.3) +
    geom_bar(stat='identity') +
    facet_grid(~Scenario+period, labeller = labeller(Scenario = function(Variable, value) {c("", "DIAG-C0to80-gr5","","","DIAG-C400-lin","","","DIAG-NZero","")})) +
    theme_singleColumn() + 
    scale_fill_manual(values = setNames(color$sector[names(vars)],vars), labels = setNames(names(vars),vars)) +
...
g$elec <- ggplot(d,aes(x=period,y=value,color=Model,group=Model)) + 
  geom_hline(yintercept=0, color = "black", size=1, alpha = 0.15) +
  geom_vline(xintercept=2020, color = "black", size=1, alpha = 0.15, linetype = "dashed") +
  geom_line(size=1) + #,linetype=parent
  geom_point() +
  ...
  scale_color_manual(values = color$model) +
  ylab("Secondary Energy|Electricity (TWh/yr)") +
  scale_x_continuous(breaks=seq(2010, 2050, 10))
...
vars <- c(
  ...
  ##"Non-Biomass Renewables" = "Secondary Energy|Electricity|Non-Biomass Renewables",
  ...
  ##"Fossil" = "Secondary Energy|Electricity|Fossil",
  ##"Fossil w/ CCS" = "Secondary Energy|Electricity|Fossil|w/ CCS",
  ##"Fossil w/o CCS" = "Secondary Energy|Electricity|Fossil|w/o CCS",
  NULL
)
...
vars <- c(
  ...
  ##"Non-Biomass Renewables" = "Capacity|Electricity|Non-Biomass Renewables",
  ...
  "Gas CCGT" = "Capacity|Electricity|Gas|CCGT",
  ...
  ##"Fossil" = "Capacity|Electricity|Fossil",
  ##"Fossil w/ CCS" = "Capacity|Electricity|Fossil|w/ CCS",
  ##"Fossil w/o CCS" = "Capacity|Electricity|Fossil|w/o CCS",
  NULL
)
...
maxY <- max(as.data.frame(d %>% group_by(period,Model,Scenario) %>% summarize(value = sum(value)))[,]$value)
