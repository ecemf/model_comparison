...
#rename scenarios
scenRename <- c(
  "DIAG-C400-limBio" = "DIAG-C400-LimBio",
  "DIAG-C400-lin-LimBio" = "DIAG-C400-LimBio",
  "DIAG-C400-LimBio " = "DIAG-C400-LimBio",
  "DIAG-C400-LimBio " = "DIAG-C400-LimBio",
  "DIAG-C400-LimBioÂ " = "DIAG-C400-LimBio",
  "DIAG-C400-limCCS" = "DIAG-C400-LimCCS",
  "DIAG-C400-lin-LimCCS" = "DIAG-C400-LimCCS",
  "DIAG-C400-LimCCS" = "DIAG-C400-LimCCS",
  "DIAG-C400-limNuclear" = "DIAG-C400-LimNuclear",
  "DIAG-C400-LimNuc" = "DIAG-C400-LimNuclear",
  "DIAG-C400-LimNuclear" = "DIAG-C400-LimNuclear",
...
#scenario
  ...
  "DIAG-C400-LimBio" = "#005900",
  "DIAG-C400-LimCCS" = "#999959",
  "DIAG-C400-LimNuclear" = "#ff33ff",
...
linePlot <- function(data, scen=policyScen, title="", colorDim="Model", linetypeDim=NULL, xdim="Period", ydim="Value", facetDim="Scenario", legend = list(nrow=NULL), min=0, max=NULL, minPeriod=2005, maxPeriod=2050, labels=NULL, facet = list(nrow=NULL,ncol=2), percentage=FALSE){
...
if(type=="techConstraint"){
  ...
  out = paste0(out,"### Carbon Sequestration\n\n");
  
  cat(out)
  
  print(g$`limCCS - Carbon Sequestration`)
  
  out = "\n\n";
  out = paste0(out,"### Carbon Sequestration per source\n\n");
  
  cat(out)
  
  print(g$`limCCS - Carbon Sequestration per source`)
...
if(type=="paradigmShift"){
  ...
  print(g$`HighElectrification - Electricity Share in Final Energy`)
  ...
  print(g$`HighElectrification - Total Electricity`)
  ...
  print(g$`HighElectrification - Electricity Final Energy per sector`)
